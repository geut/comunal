...
Fork the project [on GitHub](https://github.com/geut/comunal) and check out your copy locally.

```bash
$ git clone git@github.com:username/comunal.git
$ cd comunal
$ npm install
$ git remote add upstream git://github.com/geut/comunal.git
```
