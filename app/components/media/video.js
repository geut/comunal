...
class VideoExample extends React.Component {
  ...
  setStreamToVideo (stream) {
    let video = this.refs.capturer.querySelector('video')
  ...
  releaseStreamFromVideo () {
    this.refs.capturer.querySelector('video').src = ''
  }
  downloadVideo (blob) {
  ...
  render () {
    ...
    return (
      <div className='mt-4 border border-green-400 rounded' ref='capturer'>
        <h3 className='mb-2 text-gray-700'>Video Recorder</h3>
        <MediaCapturer
